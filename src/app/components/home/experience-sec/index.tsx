                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="space-y-7 md:space-y-12">
                        {experiences.map((exp, index) => (
                            <div key={exp.id || index} className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 md:gap-4 xl:gap-8 items-start relative">
                                <div className="">
                                ...
                                <div className=" relative">
                                    ...
                                    <div className="pl-4 lg:pl-7">
                                        ...
                                        <p className="text-base font-normal">{exp.type} • {exp.location}</p>
                                    </div>
                                </div>
